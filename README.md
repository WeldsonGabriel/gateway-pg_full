...
```bash
migrate -path db/migrate -path "E:\PORTIFOLIO\Full-Clycle\gatway-pagamento\gateway-pg_full\db\migrations" -database "postgresql://postgres:postgres@localhost:5432/gateway?sslmode=disable" up
